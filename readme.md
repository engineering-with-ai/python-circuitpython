...
![](https://img.shields.io/gitlab/pipeline-status/agent-framework/python-circuitpython?branch=main&logo=gitlab)
![](https://gitlab.com/agent-framework/python-circuitpython/badges/main/coverage.svg)

...
![](https://img.shields.io/gitlab/pipeline-status/engineering-with-ai/python-circuitpython?branch=main&logo=gitlab)
![](https://gitlab.com/engineering-with-ai/python-circuitpython/badges/main/coverage.svg)
